...
Le meilleur modèle est obtenu avec l'utilisation d'une estimation gaussienne de la densité.
...
On commence par mettre les variables sur la même échelle. 
...
Puis on entraîne le modèle en testant différentes valeurs de $k$. 
...
On effectuer les prédictions sur le jeu de données de test pour calculer l'erreur.
