...
lapply(
  X = list(
    ...
    list(geom = "abline", new = list(colour = "#498bf5")),
    list(geom = "point", new = list(colour = "#498bf5")),
    list(geom = "density", new = list(colour = "#498bf5")),
    list(geom = "errorbar", new = list(colour = "#498bf5")),
    list(geom = "errorbarh", new = list(colour = "#498bf5")),
    list(geom = "hline", new = list(colour = "#498bf5")),
    list(geom = "vline", new = list(colour = "#498bf5")),
    list(geom = "line", new = list(colour = "#498bf5")),
    list(geom = "text", new = list(colour = "black")),
    # Geoms that only require a default fill
    list(geom = "area", new = list(fill = "#498bf5", colour = "#498bf5", alpha = .7)),
    list(geom = "ribbon", new = list(fill = "#498bf5")),
    list(geom = "bar", new = list(fill = "#498bf5")),
    list(geom = "col", new = list(fill = "#498bf5")),
    list(geom = "dotplot", new = list(fill = "#498bf5")),
    # Special geoms
    list(geom = "boxplot", new = list(fill = "#498bf5", colour = "#498bf5", alpha = .7)),
    list(geom = "smooth", new = list(fill = "#498bf5", colour = "#498bf5", alpha = .7)),
    list(geom = "dotplot", new = list(colour = "#498bf5", fill = "#498bf5"))
  ),
  FUN = function(list) do.call(what = ggplot2::update_geom_defaults, args = list)
)
```
